...
- `compaction.thresholdMinContextWindow` = `-1`; when positive, `thresholdPercent` applies only to models whose context window is at least this size, and smaller windows use the reserve-based threshold.
