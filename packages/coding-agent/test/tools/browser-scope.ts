...
/** Every raw and mutating browser verb the tab helpers can emit; raw verbs must be listed explicitly. */
...
/** Loopback origins for a `Bun.serve`/`http.Server` fixture: both spellings Chrome may report. */
