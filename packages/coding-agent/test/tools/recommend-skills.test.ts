...
import type { JudgmentUsage, ResolvedJudge } from "@oh-my-pi/pi-coding-agent/judgment";
...
describe("recommend_skills", () => {
	...
	it("renders the ranking, the mode, and the judge provenance", async () => {
		...
		expect(text).toContain("judge: online tiny/smol/default · model openai-codex/gpt-5.6-sol · synthetic one-hot");
